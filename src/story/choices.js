// bg
const akademy = require("./bg/main.jpeg");
// bgm
const take = require("./bgm/take.mp3");
// speakers
const b = "Traveller";
// sprites
const bn = require("./sprites/kaveh-neutral.png");
const bh = require("./sprites/kaveh-happy.png");
const bp = require("./sprites/kaveh-pout.png");
